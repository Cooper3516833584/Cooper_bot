...
验证：`test/unit/test_memory_vectors.py`（16 passed）；10 个 memory 专项文件 68 passed；含 AI/dispatch/Kimi argv/lifecycle 的组合 151 passed。真实 provider 未运行（`tools/diagnostics/probe_memory_embedding.py` 需联网授权）。
